...
constexpr int NUM_COLORS = 64;
constexpr int NUM_VARIATIONS = 8;
constexpr int PALETTE_ARRAY_SIZE = NUM_COLORS * NUM_VARIATIONS * 3;

constexpr std::array<uint8_t, PALETTE_ARRAY_SIZE> NTSC_PALETTE = {
...
constexpr std::array<uint8_t, PALETTE_ARRAY_SIZE> FCEUX_PALETTE = {
    0x1D << 2, 0x1D << 2, 0x1D << 2, 0x09 << 2, 0x06 << 2, 0x23 << 2, 0x00 << 2,
    0x00 << 2, 0x2A << 2, 0x11 << 2, 0x00 << 2, 0x27 << 2, 0x23 << 2, 0x00 << 2,
    0x1D << 2, 0x2A << 2, 0x00 << 2, 0x04 << 2, 0x29 << 2, 0x00 << 2, 0x00 << 2,
    0x1F << 2, 0x02 << 2, 0x00 << 2, 0x10 << 2, 0x0B << 2, 0x00 << 2, 0x00 << 2,
    0x11 << 2, 0x00 << 2, 0x00 << 2, 0x14 << 2, 0x00 << 2, 0x00 << 2, 0x0F << 2,
    0x05 << 2, 0x06 << 2, 0x0F << 2, 0x17 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2,
    0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x2F << 2,
    0x2F << 2, 0x2F << 2, 0x00 << 2, 0x1C << 2, 0x3B << 2, 0x08 << 2, 0x0E << 2,
    0x3B << 2, 0x20 << 2, 0x00 << 2, 0x3C << 2, 0x2F << 2, 0x00 << 2, 0x2F << 2,
    0x39 << 2, 0x00 << 2, 0x16 << 2, 0x36 << 2, 0x0A << 2, 0x00 << 2, 0x32 << 2,
    0x13 << 2, 0x03 << 2, 0x22 << 2, 0x1C << 2, 0x00 << 2, 0x00 << 2, 0x25 << 2,
    0x00 << 2, 0x00 << 2, 0x2A << 2, 0x00 << 2, 0x00 << 2, 0x24 << 2, 0x0E << 2,
    0x00 << 2, 0x20 << 2, 0x22 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2,
    0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x3F << 2, 0x3F << 2,
    0x3F << 2, 0x0F << 2, 0x2F << 2, 0x3F << 2, 0x17 << 2, 0x25 << 2, 0x3F << 2,
    0x33 << 2, 0x22 << 2, 0x3F << 2, 0x3D << 2, 0x1E << 2, 0x3F << 2, 0x3F << 2,
    0x1D << 2, 0x2D << 2, 0x3F << 2, 0x1D << 2, 0x18 << 2, 0x3F << 2, 0x26 << 2,
    0x0E << 2, 0x3C << 2, 0x2F << 2, 0x0F << 2, 0x20 << 2, 0x34 << 2, 0x04 << 2,
    0x13 << 2, 0x37 << 2, 0x12 << 2, 0x16 << 2, 0x3E << 2, 0x26 << 2, 0x00 << 2,
    0x3A << 2, 0x36 << 2, 0x1E << 2, 0x1E << 2, 0x1E << 2, 0x00 << 2, 0x00 << 2,
    0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x3F << 2, 0x3F << 2, 0x3F << 2,
    0x2A << 2, 0x39 << 2, 0x3F << 2, 0x31 << 2, 0x35 << 2, 0x3F << 2, 0x35 << 2,
    0x32 << 2, 0x3F << 2, 0x3F << 2, 0x31 << 2, 0x3F << 2, 0x3F << 2, 0x31 << 2,
    0x36 << 2, 0x3F << 2, 0x2F << 2, 0x2C << 2, 0x3F << 2, 0x36 << 2, 0x2A << 2,
    0x3F << 2, 0x39 << 2, 0x28 << 2, 0x38 << 2, 0x3F << 2, 0x28 << 2, 0x2A << 2,
    0x3C << 2, 0x2F << 2, 0x2C << 2, 0x3F << 2, 0x33 << 2, 0x27 << 2, 0x3F << 2,
    0x3C << 2, 0x31 << 2, 0x31 << 2, 0x31 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2,
    0x00 << 2, 0x00 << 2, 0x00 << 2, 0x1D << 2, 0x1D << 2, 0x1D << 2, 0x09 << 2,
    0x06 << 2, 0x23 << 2, 0x00 << 2, 0x00 << 2, 0x2A << 2, 0x11 << 2, 0x00 << 2,
    0x27 << 2, 0x23 << 2, 0x00 << 2, 0x1D << 2, 0x2A << 2, 0x00 << 2, 0x04 << 2,
    0x29 << 2, 0x00 << 2, 0x00 << 2, 0x1F << 2, 0x02 << 2, 0x00 << 2, 0x10 << 2,
    0x0B << 2, 0x00 << 2, 0x00 << 2, 0x11 << 2, 0x00 << 2, 0x00 << 2, 0x14 << 2,
    0x00 << 2, 0x00 << 2, 0x0F << 2, 0x05 << 2, 0x06 << 2, 0x0F << 2, 0x17 << 2,
    0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2,
    0x00 << 2, 0x00 << 2, 0x2F << 2, 0x2F << 2, 0x2F << 2, 0x00 << 2, 0x1C << 2,
    0x3B << 2, 0x08 << 2, 0x0E << 2, 0x3B << 2, 0x20 << 2, 0x00 << 2, 0x3C << 2,
    0x2F << 2, 0x00 << 2, 0x2F << 2, 0x39 << 2, 0x00 << 2, 0x16 << 2, 0x36 << 2,
    0x0A << 2, 0x00 << 2, 0x32 << 2, 0x13 << 2, 0x03 << 2, 0x22 << 2, 0x1C << 2,
    0x00 << 2, 0x00 << 2, 0x25 << 2, 0x00 << 2, 0x00 << 2, 0x2A << 2, 0x00 << 2,
    0x00 << 2, 0x24 << 2, 0x0E << 2, 0x00 << 2, 0x20 << 2, 0x22 << 2, 0x00 << 2,
    0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2,
    0x00 << 2, 0x3F << 2, 0x3F << 2, 0x3F << 2, 0x0F << 2, 0x2F << 2, 0x3F << 2,
    0x17 << 2, 0x25 << 2, 0x3F << 2, 0x33 << 2, 0x22 << 2, 0x3F << 2, 0x3D << 2,
    0x1E << 2, 0x3F << 2, 0x3F << 2, 0x1D << 2, 0x2D << 2, 0x3F << 2, 0x1D << 2,
    0x18 << 2, 0x3F << 2, 0x26 << 2, 0x0E << 2, 0x3C << 2, 0x2F << 2, 0x0F << 2,
    0x20 << 2, 0x34 << 2, 0x04 << 2, 0x13 << 2, 0x37 << 2, 0x12 << 2, 0x16 << 2,
    0x3E << 2, 0x26 << 2, 0x00 << 2, 0x3A << 2, 0x36 << 2, 0x1E << 2, 0x1E << 2,
    0x1E << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2,
    0x3F << 2, 0x3F << 2, 0x3F << 2, 0x2A << 2, 0x39 << 2, 0x3F << 2, 0x31 << 2,
    0x35 << 2, 0x3F << 2, 0x35 << 2, 0x32 << 2, 0x3F << 2, 0x3F << 2, 0x31 << 2,
    0x3F << 2, 0x3F << 2, 0x31 << 2, 0x36 << 2, 0x3F << 2, 0x2F << 2, 0x2C << 2,
    0x3F << 2, 0x36 << 2, 0x2A << 2, 0x3F << 2, 0x39 << 2, 0x28 << 2, 0x38 << 2,
    0x3F << 2, 0x28 << 2, 0x2A << 2, 0x3C << 2, 0x2F << 2, 0x2C << 2, 0x3F << 2,
    0x33 << 2, 0x27 << 2, 0x3F << 2, 0x3C << 2, 0x31 << 2, 0x31 << 2, 0x31 << 2,
    0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x1D << 2,
    0x1D << 2, 0x1D << 2, 0x09 << 2, 0x06 << 2, 0x23 << 2, 0x00 << 2, 0x00 << 2,
    0x2A << 2, 0x11 << 2, 0x00 << 2, 0x27 << 2, 0x23 << 2, 0x00 << 2, 0x1D << 2,
    0x2A << 2, 0x00 << 2, 0x04 << 2, 0x29 << 2, 0x00 << 2, 0x00 << 2, 0x1F << 2,
    0x02 << 2, 0x00 << 2, 0x10 << 2, 0x0B << 2, 0x00 << 2, 0x00 << 2, 0x11 << 2,
    0x00 << 2, 0x00 << 2, 0x14 << 2, 0x00 << 2, 0x00 << 2, 0x0F << 2, 0x05 << 2,
    0x06 << 2, 0x0F << 2, 0x17 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2,
    0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x2F << 2, 0x2F << 2,
    0x2F << 2, 0x00 << 2, 0x1C << 2, 0x3B << 2, 0x08 << 2, 0x0E << 2, 0x3B << 2,
    0x20 << 2, 0x00 << 2, 0x3C << 2, 0x2F << 2, 0x00 << 2, 0x2F << 2, 0x39 << 2,
    0x00 << 2, 0x16 << 2, 0x36 << 2, 0x0A << 2, 0x00 << 2, 0x32 << 2, 0x13 << 2,
    0x03 << 2, 0x22 << 2, 0x1C << 2, 0x00 << 2, 0x00 << 2, 0x25 << 2, 0x00 << 2,
    0x00 << 2, 0x2A << 2, 0x00 << 2, 0x00 << 2, 0x24 << 2, 0x0E << 2, 0x00 << 2,
    0x20 << 2, 0x22 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2,
    0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x3F << 2, 0x3F << 2, 0x3F << 2,
    0x0F << 2, 0x2F << 2, 0x3F << 2, 0x17 << 2, 0x25 << 2, 0x3F << 2, 0x33 << 2,
    0x22 << 2, 0x3F << 2, 0x3D << 2, 0x1E << 2, 0x3F << 2, 0x3F << 2, 0x1D << 2,
    0x2D << 2, 0x3F << 2, 0x1D << 2, 0x18 << 2, 0x3F << 2, 0x26 << 2, 0x0E << 2,
    0x3C << 2, 0x2F << 2, 0x0F << 2, 0x20 << 2, 0x34 << 2, 0x04 << 2, 0x13 << 2,
    0x37 << 2, 0x12 << 2, 0x16 << 2, 0x3E << 2, 0x26 << 2, 0x00 << 2, 0x3A << 2,
    0x36 << 2, 0x1E << 2, 0x1E << 2, 0x1E << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2,
    0x00 << 2, 0x00 << 2, 0x00 << 2, 0x3F << 2, 0x3F << 2, 0x3F << 2, 0x2A << 2,
    0x39 << 2, 0x3F << 2, 0x31 << 2, 0x35 << 2, 0x3F << 2, 0x35 << 2, 0x32 << 2,
    0x3F << 2, 0x3F << 2, 0x31 << 2, 0x3F << 2, 0x3F << 2, 0x31 << 2, 0x36 << 2,
    0x3F << 2, 0x2F << 2, 0x2C << 2, 0x3F << 2, 0x36 << 2, 0x2A << 2, 0x3F << 2,
    0x39 << 2, 0x28 << 2, 0x38 << 2, 0x3F << 2, 0x28 << 2, 0x2A << 2, 0x3C << 2,
    0x2F << 2, 0x2C << 2, 0x3F << 2, 0x33 << 2, 0x27 << 2, 0x3F << 2, 0x3C << 2,
    0x31 << 2, 0x31 << 2, 0x31 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2, 0x00 << 2,
    0x00 << 2, 0x00 << 2};
